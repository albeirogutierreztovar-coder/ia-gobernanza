  ...
  evidences: [
    {
      id: 'ev-1',
      organizationId: 'org-nova',
      name: 'Política General de Seguridad de la Información y Gestión de IA',
      description: 'Documento marco aprobado por la Alta Dirección con objetivos de seguridad y principios éticos.',
      owner: 'Ana Martínez',
      process: 'Gerencia Estratégica',
      standard: 'Integrado',
      controls: 4,
      controlCode: 'A.5.1 / ISO 42001 Cl. 5.2',
      status: 'Vigente',
      date: '2026-01-15',
      expires: '2027-01-15',
      fileType: 'PDF',
      fileSize: '1.4 MB',
      reviewedBy: 'Comité de Dirección'
    },
    {
      id: 'ev-2',
      organizationId: 'org-nova',
      name: 'Registro de Evaluación de Impacto de IA (AIA) - Modelo Predictivo',
      description: 'Análisis de riesgos algorítmicos, derechos fundamentales y medidas de mitigación del modelo de riesgo de entrega.',
      owner: 'Elena Gómez',
      process: 'Operaciones de Flota y Envíos',
      standard: 'ISO/IEC 42001',
      controls: 3,
      controlCode: 'ISO 42001 Cl. 6.1.4',
      status: 'Vigente',
      date: '2026-06-20',
      expires: '2027-06-20',
      fileType: 'PDF',
      fileSize: '3.2 MB',
      reviewedBy: 'Oficial de Ética IA'
    },
    {
      id: 'ev-3',
      organizationId: 'org-nova',
      name: 'Matriz de Asignación y Revisión de Llaves Criptográficas Anual',
      description: 'Registro de rotación de certificados TLS y claves AES-256 en servicios cloud.',
      owner: 'Luis Gómez',
      process: 'Tecnología e Infraestructura Cloud',
      standard: 'ISO/IEC 27001',
      controls: 2,
      controlCode: 'Control SoA A.8.24',
      status: 'Por vencer',
      date: '2025-09-24',
      expires: '2026-09-24',
      fileType: 'XLSX',
      fileSize: '840 KB',
      reviewedBy: 'Líder DevOps'
    },
    {
      id: 'ev-4',
      organizationId: 'org-nova',
      name: 'Log de Auditoría de Intervención Humana (Human-in-the-loop Override)',
      description: 'Trazabilidad de intervenciones de operadores sobre despachos automatizados por IA.',
      owner: 'Javier Silva',
      process: 'Operaciones de Flota y Envíos',
      standard: 'ISO/IEC 42001',
      controls: 2,
      controlCode: 'Control SoA A.8.1',
      status: 'Vigente',
      date: '2026-08-30',
      expires: '2026-11-30',
      fileType: 'CSV',
      fileSize: '5.6 MB',
      reviewedBy: 'Supervisor de Operaciones'
    },
    {
      id: 'ev-5',
      organizationId: 'org-nova',
      name: 'Informe de Auditoría Interna Semestral H1-2026 y Muestreo de Controles',
      description: 'Dictamen de conformidad emitido por el equipo auditor independiente interno.',
      owner: 'Carlos Ruiz',
      process: 'Gerencia Estratégica',
      standard: 'Integrado',
      controls: 5,
      controlCode: 'ISO 27001 Cl. 9.2 & 10.1',
      status: 'Vigente',
      date: '2026-08-28',
      expires: '2027-02-28',
      fileType: 'PDF',
      fileSize: '4.8 MB',
      reviewedBy: 'Auditor Líder'
    },
    {
      id: 'ev-6',
      organizationId: 'org-nova',
      name: 'Pruebas de Detección y Mitigación de Sesgo Algorítmico - RRHH',
      description: 'Informe de métricas Fairlearn y matrices de confusión para el modelo de selección.',
      owner: 'Elena Gómez',
      process: 'Talento Humano y Cultura',
      standard: 'ISO/IEC 42001',
      controls: 2,
      controlCode: 'Control SoA A.6.2',
    ...
    },
    {
      id: 'ev-7',
      organizationId: 'org-nova',
      name: 'Acuerdo de Nivel de Servicio (SLA) y DPA con Proveedor Cloud AI',
      description: 'Contrato marco con cláusulas de no entrenamiento con datos del cliente y cifrado.',
      owner: 'María Pérez',
      process: 'Comercial y Cuentas Clave',
      standard: 'ISO/IEC 27001',
      controls: 1,
      controlCode: 'Control SoA A.5.20',
      status: 'Vencida',
      date: '2025-07-10',
      expires: '2026-07-10',
      fileType: 'PDF',
  ...
  documents: [
    {
      ...
      organizationId: 'org-nova',
      code: 'POL-SEG-01',
      name: 'Política General de Seguridad de la Información y Gobernanza de IA',
      type: 'Política',
      process: 'Gerencia Estratégica',
      standard: 'Integrado',
      status: 'Vigente',
      currentVersion: 'v2.1',
      date: '2026-01-15',
      description: 'Directriz corporativa que establece compromisos de confidencialidad, integridad, disponibilidad y uso ético de la IA.',
      author: 'Ana Martínez',
      approver: 'Junta Directiva'
    },
    {
      id: 'doc-2',
      organizationId: 'org-nova',
      code: 'MAN-SGIA-01',
      name: 'Manual del Sistema de Gestión Integrado ISO/IEC 27001 & ISO/IEC 42001',
      type: 'Manual',
      process: 'Gerencia Estratégica',
      standard: 'Integrado',
      status: 'Vigente',
      currentVersion: 'v1.4',
      date: '2026-02-10',
      description: 'Estructura general, alcance organizativo, mapeo de procesos e interacción con las partes interesadas.',
      author: 'Carlos Ruiz',
    ...
    },
    {
      ...
      organizationId: 'org-nova',
      code: 'PRC-AIA-02',
      name: 'Procedimiento de Evaluación de Impacto de Sistemas de Inteligencia Artificial (AIA)',
      type: 'Procedimiento',
      process: 'Tecnología e Infraestructura Cloud',
      standard: 'ISO/IEC 42001',
      status: 'Vigente',
      currentVersion: 'v2.0',
      date: '2026-03-01',
      description: 'Metodología obligatoria para clasificar riesgos algorítmicos antes de pasar a producción.',
      author: 'Elena Gómez',
      approver: 'Comité de IA'
    },
    {
      id: 'doc-4',
      organizationId: 'org-nova',
      code: 'MAT-SOA-01',
      name: 'Declaración de Aplicabilidad de Controles Integrada (SoA)',
      type: 'Matriz',
      process: 'Gerencia Estratégica',
      standard: 'Integrado',
      status: 'Vigente',
      currentVersion: 'v3.0',
      date: '2026-09-15',
      description: 'Inventario oficial y justificación técnica de 100% de los controles Anexo A ISO 27001 e ISO 42001.',
      author: 'Luis Carlos Morales',
      approver: 'Comité de Seguridad'
    },
    {
      id: 'doc-5',
      organizationId: 'org-nova',
      code: 'PLA-CNT-03',
      name: 'Plan de Contingencia y Continuidad Operativa Multi-Región Cloud',
      type: 'Plan',
      process: 'Operaciones de Flota y Envíos',
      standard: 'ISO/IEC 27001',
      status: 'En revisión',
      currentVersion: 'v1.2',
      date: '2026-08-20',
      description: 'Protocolos de conmutación por error ante fallas del proveedor en la nube y tiempos RTO/RPO.',
      author: 'Luis Gómez',
    ...
    },
    {
      ...
      organizationId: 'org-nova',
      code: 'PRC-CAPA-01',
      name: 'Procedimiento de Gestión de No Conformidades y Acciones Correctivas (CAPA)',
      type: 'Procedimiento',
      process: 'Gerencia Estratégica',
      standard: 'Integrado',
      status: 'Vigente',
      currentVersion: 'v1.1',
      date: '2026-04-12',
      description: 'Instrucciones para análisis de causa raíz (5 Porqués / Ishikawa) y verificación de eficacia.',
      author: 'Carlos Ruiz',
      approver: 'Auditor Líder'
    },
    {
      id: 'doc-7',
      organizationId: 'org-nova',
      code: 'GUI-ETIC-01',
      name: 'Guía de Principios Éticos, Equidad Algorítmica y Supervisión Humana',
      type: 'Guía',
      process: 'Talento Humano y Cultura',
      standard: 'ISO/IEC 42001',
      status: 'Vigente',
      currentVersion: 'v1.0',
      date: '2026-05-18',
      description: 'Código de conducta técnica para científicos de datos, ingenieros de machine learning y operadores.',
      author: 'Ana Martínez',
      approver: 'Comité de Ética'
    }
  ]
};
